...
import AboutImage2 from '../../assets/images/about/about-ten-image.png'; 
import AboutImage3 from '../../assets/images/about/about-ten-image-info.png'; 
import AboutImage4 from '../../assets/images/shape/about-ten-shape.png'; 
...
function AboutSection({ className }) {
    ...
    return (
        <section id="about" className={`about-ten-area pt-130 pb-130 ${className || ''}`}>
                ...
                <div className="about-ten__wrp">
                    <div className="row">
                            ...
                            <div className="about-ten__content">
                                <ul className="nav mb-50 nav-tabs" id="serviceTab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button className={activeIndex === 1 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(1)} id="info-tab" data-bs-toggle="tab"
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button className={activeIndex === 2 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(2)} id="projection-tab" data-bs-toggle="tab"
                                            data-bs-target="#projection" type="button" role="tab"
                                            aria-controls="projection" aria-selected="false">
                                            Awards Winnings
                                        </button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <button className={activeIndex === 3 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(3)} id="business-tab" data-bs-toggle="tab"
                                ...
                                <div className="tab-content" id="serviceTabContent">
                                    <div className={activeIndex === 1 ? "tab-pane fade show active" : "tab-pane fade show"} id="info" role="tabpanel"
                                        ...
                                        <div className="info mt-50">
                                            <Link to="/page-about" className="btn-one" data-splitting>Read More
                                                <i className="fa-regular fs-14 fa-angle-right"></i></Link>
                        ...
                        <div className="about-ten__image">
                            <img className="wow bounceInRight" src={AboutImage2} alt="image"/>
                            <div className="info">
                                <img className="animation__arryUpDown" src={AboutImage3}
                                    alt="image"/>
                            </div>
                            <div className="shape">
                                <img className="animation__rotate" src={AboutImage4}
                                    alt="shape"/>
                            </div>
                        </div>
                    </div>
