...
import PortfolioImage1 from '../../assets/images/protfolio/portfolio-ten-image1.jpg'; 
import PortfolioImage2 from '../../assets/images/protfolio/portfolio-ten-image2.jpg'; 
import PortfolioImage3 from '../../assets/images/protfolio/portfolio-ten-image3.jpg'; 

function ProjectSection({ className }) {
    return (
        <section id="project" className={`portfolio-ten-area pt-130 pb-130 ${className || ''}`}>
                ...
                <div className="row g-5 justify-content-between">
                    <div className="col-lg-6 col-xxl-4">
                        <div className="portfolio-left">
                            ...
                            <Link href="page-portfolio.html" className="btn-one wow fadeInUp mt-50" data-wow-delay="200ms"
                            ...
                            <div className="portfolio-ten__item mb-50">
                                ...
                                <div className="content">
                                    <div>
                                        ...
                                        <h4 className="title"><Link className="hover-link"
                                                to="/page-portfolio-details">Technology Assessment</Link>
                                        </h4>
                                    </div>
                                    <Link to="/page-portfolio-details" className="btn-explore">
                            ...
                            <div className="portfolio-ten__item mb-50">
                                ...
                                <div className="content">
                                    <div>
                                        ...
                                        <h4 className="title"><Link className="hover-link"
                                                to="/page-portfolio-details">Transforming Businesses</Link>
                                        </h4>
                                    </div>
                                    <Link to="/page-portfolio-details" className="btn-explore">
                                        Explore More <i className="fa-regular fa-arrow-right"></i>
                            ...
                            <div className="portfolio-ten__item">
                                ...
                                <div className="content pb-0 border-0">
                                    <div>
                                        <span className="sub-title">Technology</span>
                                        <h4 className="title"><Link className="hover-link"
                                                to="/page-portfolio-details">Accelerating Business</Link>
                                        </h4>
                                    </div>
                                    <Link to="/page-portfolio-details" className="btn-explore">
                                        Explore More <i className="fa-regular fa-arrow-right"></i>
