...
import projectdetails from '../../assets/images/resource/project-details.jpg';
    ...
    return (
        <>
            ...
            <PageTitle
                ...
                breadcrumb={[
                    { link: '/', title: 'Home' },
                    { link: '/projects-details', title: 'Project Details' },
                ]}
            />
						...
						<div className="row">
							<div className="col-xl-12">
								<div className="project-details__top">
									<div className="project-details__img"> <img src={projectdetails}
											alt="Image"/> </div>
								</div>
							</div>
						</div>
								...
								<div className="col-xl-12">
									<div className="project-details__content-left">
										...
										<ul className="list-style-two mb-0">
											<li><i className="fa fa-check-circle"></i> Lorem ipsum dolor amet consectetur
												adipisicing elit</li>
											<li><i className="fa fa-check-circle"></i> Vitae pariatur molestiae odit quos enim
											</li>
											<li><i className="fa fa-check-circle"></i> Beyond more stoic this along goodness hey
												this</li>
											<li><i className="fa fa-check-circle"></i> Officiis autem similique sequi labore
											</li>
										</ul>
									</div>
								</div>
							...
							<div className="col-xl-12">
								<div className="project-details__pagination-box">
									<ul className="project-details__pagination list-unstyled clearfix">
										<li className="next">
											<div className="icon"> <a href="#" aria-label="Previous"><i
														className="far fa-arrow-left"></i></a> </div>
