...
import SlideImage1 from '../../assets/images/banner/banner-image1.jpg';
import SlideImage2 from '../../assets/images/banner/banner-image2.jpg';
import SlideImage3 from '../../assets/images/banner/banner-image3.jpg';
...
function BannerSection({ className }) {
    return (
        <section id="home" className={`banner-area ${className || ''}`}>
                        ...
                        <Swiper {...swiperOptions} className="swiper-wrapper">
                            <SwiperSlide className="swiper-slide">
                                <div className="parallax-bg">
                                    <img src={SlideImage1} alt="image" data-swiper-parallax="300" />
                                </div>
                                <div className="banner__content">
                                    ...
                                    <div data-animation="fadeInDown" data-duration="2s" data-delay="2s">
                                        <Link to="/" className="arry-btn animation__arryUpDown"><i className="fa-light fa-arrow-right-long" /></Link>
                                    </div>
                                </div>
                            </SwiperSlide>
                            <SwiperSlide className="swiper-slide">
                                <div className="parallax-bg">
                                    <img src={SlideImage2} alt="image" data-swiper-parallax="300" />
                                </div>
                                <div className="banner__content">
                                    <h1 className="title" data-animation="slideInLeft" data-duration="1s" data-delay="1s">Accelerate your business Sustainable Growth</h1>
                                    <p className="text" data-animation="slideInLeft" data-duration="1.5s" data-delay="1.1s">We bring a fresh, dynamic perspective to every client relationship, driven by a relentless energy that sparks action.</p>
                            ...
                            <SwiperSlide className="swiper-slide">
                                <div className="parallax-bg">
                                    <img src={SlideImage3} alt="image" data-swiper-parallax="300" />
                                </div>
                                <div className="banner__content">
                                    <h1 className="title" data-animation="slideInLeft" data-duration="1s" data-delay="1s">Accelerate your business Sustainable Growth</h1>
                                    <p className="text" data-animation="slideInLeft" data-duration="1.5s" data-delay="1.1s">We bring a fresh, dynamic perspective to every client relationship, driven by a relentless energy that sparks action.</p>
