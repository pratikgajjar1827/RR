...
import Navigation from '../SingleNavigation.jsx';
import MobileMenu from '../MobileMenu.jsx';

function Header({scroll = false }) {
    ...
    return (
            ...
            <div className="container">
                <div className="header-top__wrp">
                    <ul className="header-top__Links">
                        <li><i className="fa-light fa-location-dot"></i> <Link to="#0">121 King Street, Melbourne</Link></li>
                        <li><i className="fa-light fa-envelope-open-text"></i> <a href="mailto:info.company@gmail.com">info.company@gmail.com</a></li>
                    </ul>
                    <div className="header-top__socials">
                        ...
                        <Link to="#"><svg width="13" height="15" viewBox="0 0 13 15" fill="none"
                        ...
                        <Link className="pe-0" to="#"><svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
        ...
        <header className="header-area header-blur">
            <div className="container">
                <div className="header__main">
                    ...
                    <div className="main-menu main-menu-light">
                        ...
                        <div className="menu-btns light">
                            ...
                            <button onClick={toggleMobileMenu} className="menubars menubars-light" type="button" data-bs-toggle="offcanvas"
        ...
        <div className={`sidebar-area offcanvas ${isMobileMenuOpen ? 'open' : ''}`}>
            <div className="offcanvas-header">
                <Link to="/" className="logo"><img src={logoLight} alt="logo"/></Link>
            ...
            <div className="offcanvas-body sidebar__body">
                ...
                <div className="sidebar__contact-info mt-30">
                    ...
                    <ul>
                        ...
                        <li className="py-2"><i className="fa-solid fa-phone-volume"></i> <a href="tel:+912659302003">+91 2659302
                                003</a></li>
                        <li><i className="fa-solid fa-paper-plane"></i> <a
