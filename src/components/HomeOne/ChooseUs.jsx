...
import ChooseImage from '../../assets/images/choose/choose-one-image.jpg'; 

function ChooseSection({ className }) {
    const [activeIndex, setActiveIndex] = useState(2);
    const handleOnClick = (index) => { setActiveIndex(index);
            };
    return (
        <section className={`choose-one-area bg-sub pt-130 ${className || ''}`}>
                        ...
                        <div className="tab-content mt-50" id="myTabContent">
                            <div className={activeIndex === 1 ? "tab-pane fade show active" : "tab-pane fade show"} id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div className="choose-one__content">
                                    <p className="mb-50">With the rapid growth of e-commerce and the significant advantages
                                        it
                                        offers, everyone is
                                ...
                                <div className="work-ten__wrp">
                                    <div className="work-ten__item text-start">
                                        <div className="content">
                                            <h4 className="title">01. Ideation</h4>
                                    ...
                                    <div className="work-ten__item text-start">
                                        <div className="content">
                                            <h4 className="title">02. Discussion</h4>
                                            <p>We meet customers in set place to discuss the details about needs
                                                & demands now.</p>
                                        </div>
                                    </div>
                                    <div className="work-ten__item text-start">
                                        <div className="content">
                                            <h4 className="title">03. Testing & Initiate</h4>
                                            <p>We meet customers in set place to discuss the details about needs
                                                & demands now.</p>
                                        </div>
                                    </div>
                                </div>
                                <Link to="/page-about" className="btn-one mt-50" data-splitting
