...
import FeatureShapeImage from '../../assets/images/shape/feature-item-shape.png';

function FeaturesSection({ className }) {
    return (


<section className={`feature-area pb-130 ${className || ''}`}>
    <div className="feature__wrp">
        <div className="row g-0">
            <div className="col-sm-6 col-lg-3">
                <div className="feature__item">
                    <div className="bg-line">
                        <img src={FeatureShapeImage} alt="shape"/>
                    </div>
                    ...
                    <div className="feature__content">
                        <h4><Link className="hover-link" to="page-service-details">Punctual Service Delivery</Link>
                        </h4>
                        <p>We promise cost-effective business consulting solutions designed to help you lower
                            expenses and boost profits.</p>
                    </div>
                    <Link to="/page-service-details" className="arrow-btn"><i
            ...
            <div className="col-sm-6 col-lg-3">
                <div className="feature__item">
                    ...
                    <div className="feature__content">
                        <h4><Link className="hover-link" to="/page-service-details">Cutting-Edge Technology</Link>
                        </h4>
                        <p>We promise cost-effective business consulting solutions designed to help you lower
                            expenses and boost profits.</p>
                    </div>
            ...
            <div className="col-sm-6 col-lg-3">
                <div className="feature__item">
                    ...
                    <div className="feature__content">
                        <h4><Link className="hover-link" to="/page-service-details">Manage Investment</Link></h4>
                        <p>We promise cost-effective business consulting solutions designed to help you lower
                            expenses and boost profits.</p>
                    </div>
                    <Link to="/page-service-details" className="arrow-btn"><i
            ...
            <div className="col-sm-6 col-lg-3">
                <div className="feature__item">
                    ...
                    <div className="feature__content">
                        <h4><Link className="hover-link" to="page-service-details.html">Financial Advice</Link></h4>
                        <p>We promise cost-effective business consulting solutions designed to help you lower
                            expenses and boost profits.</p>
                    </div>
                    <Link to="/page-service-details" className="arrow-btn"><i
    ...
    <div className="container">
        <div className="feature__text wow fadeInUp mt-50" data-wow-delay="00ms" data-wow-duration="1500ms">
            <span>HURRY</span>
            <p>Choose from our selection of the best places. <Link to="/page-projects"> Get a project in
                    mind?</Link></p>
        </div>
    </div>
</section>
