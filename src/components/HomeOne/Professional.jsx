...
import ProfessionalImage from '../../assets/images/professional/professional-image.jpg';
...
function OfferSection({ className }) {
    ...
    const countOffer = 20;
    const countOffer2 = 100;
    return (

<section id="project" className={`professional-area pt-130 pb-130 ${className || ''}`}>
    <div className="container">
        <div className="row g-0">
            <div className="col-xl-6">
                <div className="professional__image wow">
                    <img src={ProfessionalImage} alt="image"/>
                    <div className="content">
                        <ul>
                            ...
                            <li className="info">
                                <h3><span className="count"><CounterUp count={countOffer} time={3} /></span>k+</h3>
                                <p>Happy User</p>
                            </li>
                        </ul>
                        <ul className="last-item">
                            ...
                            <li className="info">
                                <h3><span className="count"><CounterUp count={countOffer2} time={3} /></span>+</h3>
                                <p>Award Winer</p>
                            </li>
                        </ul>
                    </div>
            ...
            <div className="col-xl-6">
                <div className="professional__content">
                    <div className="section-header">
                        <h2 className="wow splt-txt" data-splitting>A flourishing business run by genuine
                            professionals.</h2>
                    </div>
                    <div>
                        <ul className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <li><i className="fa-solid fa-check"></i> A Strong and Resilient Brand Identity</li>
                            <li><i className="fa-solid fa-check"></i> Retail Search Engine Optimization (SEO)</li>
                            <li><i className="fa-solid fa-check"></i> Proven Strategies for Effective Retail
                                Marketing
                            </li>
                        </ul>
                        <Link to="/page-about" className="btn-one mt-50 wow fadeInUp" data-wow-delay="200ms"
                ...
                <div className="col-xl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div className="professional__item">
                        ...
                        <div className="content">
                            ...
                            <p className="text">We take pride in staying ahead of the curve by offering innovative
                                solutions that
