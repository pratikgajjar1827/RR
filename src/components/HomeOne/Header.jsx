            ...
            <div className="offcanvas-body sidebar__body">
                ...
                <div className="sidebar__contact-info mt-30">
                    ...
                    <ul>
                        ...
                        <li className="py-2"><i className="fa-solid fa-phone-volume"></i> <a href="tel:+912659302003">+91 2659302 003</a></li>
                        <li><i className="fa-solid fa-paper-plane"></i> <a href="mailto:info.company@gmail.com">info.company@gmail.com</a></li>
                    </ul>
                </div>
