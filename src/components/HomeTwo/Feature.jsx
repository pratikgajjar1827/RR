...
import FeaturesImage1 from '../../assets/images/icon/users.png'; 

function FeaturesSection({ className }) {
    return (
        <section className={`feature-two-area pt-130 pb-130 ${className || ''}`}>
            <div className="container">
                <div className="feature-two__wrp">
                    ...
                    <div className="row g-4">
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="feature-two__item">
                                ...
                                <div className="feature__content">
                                    <h4><Link className="hover-link" to="/page-service-details">Punctual Service
                                            Delivery</Link></h4>
                                ...
                                <Link to="/page-service-details" className="readMore-btn">Read More <i
                        ...
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="feature-two__item">
                                ...
                                <div className="feature__content">
                                    <h4><Link className="hover-link" to="/page-service-details">Cutting-Edge
                                            Technology</Link></h4>
                        ...
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="feature-two__item">
                                ...
                                <div className="feature__content">
                                    <h4><Link className="hover-link" to="/page-service-details">Manage Investment</Link>
                                    </h4>
                    ...
                    <div className="feature-two__text mt-50 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        ...
                        <p>Save your precious time and effort spent for finding a solution. <Link to="/contact">
                                Contact Us
                                Now</Link></p>
                    </div>
                </div>
