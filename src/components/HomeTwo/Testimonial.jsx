...
import TestiThumb1 from '../../assets/images/shape/testimonial-shape.png';
import TestiThumb2 from '../../assets/images/testimonial/testimonial-image.png';
...
function TestimonialSectionTwo({ className }) {
    return (
        <section className={`testimonial-area bg-sub pt-130 pb-130 ${className || ''}`}>
            <div className="testimonial__shape">
                <img src={TestiThumb1} alt="shape"/>
            </div>
            <div className="testimonial__image animation__arryLeftRight">
                <img className="wow bounceInRight" src={TestiThumb2} alt="image"/>
            </div>
            <div className="container">
                <div className="testimonial__wrp">
                    <div className="section-header mb-50">
                        <h6>30 Years of Growing Together with Our Clients</h6>
                        <h2 className="wow splt-txt" data-splitting>Scale, grow, and optimize as <br /> quickly as you need
                            to.
                        </h2>
                    </div>
                                ...
                                <div className="swiper-wrapper">
                                    <SwiperSlide className="swiper-slide">
                                        <div className="testimonial__item">
                                            ...
                                            <p>It’s a great experience with centres through Stratify. We hired my own
                                                remote team
                                                and I
                                                have complete control over the
                                                team which means working from home anywhere</p>
                                            <div className="info">
                                    ...
                                    <SwiperSlide className="swiper-slide">
                                        <div className="testimonial__item">
                                            ...
                                            <p>Partnering with Stratify has been great. I hired my remote team and
                                                have
                                                full control, allowing for flexible work from
                                                anywhere
                                                and getting great results.</p>
                                            <div className="info">
                        ...
                        <div className="col-lg-3 col-xxl-2">
                            <div className="testimonial__review">
                                ...
                                <div className="testimonial__slider-arry">
                                    ...
                                    <button className="arry-next testimonial__arry-next"><i
