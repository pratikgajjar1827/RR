...
function ServicesSection({ className }) {
    return (
        <section id="services" className={`service-aera pt-130 pb-130 ${className || ''}`}>
            <div className="container">
                <div className="section-header mb-50">
                    <h2 className="wow splt-txt" data-splitting>We Are Experts in Our Fields</h2>
                    <p className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">True experts in the field
                        will offer you the best strategy to navigate <br /> your investments.</p>
                </div>
                    ...
                    <div className="row g-5">
                        <div className="col-md-6 col-xl-3">
                            <div className="service__item">
                                ...
                                <h4><Link to="/page-service-details">Business Strategy and Planning</Link></h4>
                                <div className="image">
                                    <img src={ServiceImage1} alt="image"/>
                                </div>
                                <p className="text">Business Consulting, Strategy, Branding Identity, Interaction Design &
                                    Development, & SEO
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6 col-xl-3">
                            <div className="service__item second-child">
                                ...
                                <h4><Link to="/page-service-details">International Business
                                        Consulting</Link></h4>
                                <div className="image">
                                    <img src={ServiceImage2} alt="image"/>
                                </div>
                                <p className="text">Financial Consulting, Insurance Consulting, Financial Management,
                                    Investment
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6 col-xl-3">
                            <div className="service__item">
                                ...
                                <h4><Link to="/page-service-details">E-Commerce and Market</Link></h4>
                                <div className="image">
                                    <img src={ServiceImage3} alt="image"/>
                                </div>
                                <p className="text">Analysis Market. E-Commerce Strategy, <br /> Consumer Consulting
                                </p>
                            </div>
                        </div>
                        <div className="col-md-6 col-xl-3">
                            <div className="service__item last-child">
                                ...
                                <h4><Link to="/page-service-details">Human Resources and Management</Link></h4>
                                <div className="image">
                                    <img src={ServiceImage4} alt="image"/>
                                </div>
                                <p className="text">HR Consulting, Legal Advice, and Business ManagementSEO
                                </p>
                            </div>
                        </div>
                    </div>
