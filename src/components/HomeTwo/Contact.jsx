...
function ContactSection({ className }) {
    return (
        <section id="contacts" className={`contact-two-area pt-130 pb-130 bg-sub ${className || ''}`}>
                        ...
                        <div className="contact-two-left">
                            ...
                            <div className="contact-two__form">
                                <form action="#">
                                    ...
                                    <button className="btn-one mt-50" data-splitting data-text="Send Message">Send
                                        Message</button>
                                </form>
                            </div>
                        </div>
