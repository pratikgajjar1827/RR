...
function AboutSection({ className }) {
    const countOffer =39 ;
    return (
        <section id="contacts" className={`about-eleven-area ${className || ''}`}>
                        ...
                        <div className="contact-two-left">
                            <div className="contact-two__content">
                                ...
                                <ul>
                                    <li className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        ...
                                        <a href="contact.html">4140 Parker Rd. Allentown, New Mexico 31134</a>
                                    </li>
                            ...
                            <div className="contact-two__form">
                                <form action="#">
                                    ...
                                    <button className="btn-one mt-50" data-splitting data-text="Send Message">Send Message</button>
                                </form>
                            </div>
                        </div>
                    </div>
