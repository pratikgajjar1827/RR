...
import BannerImage1 from '../../assets/images/banner/banner-eleven-shape.png';
import BannerImage2 from '../../assets/images/banner/banner-eleven-image.png';
import BannerImage3 from '../../assets/images/banner/banner-eleven-info2.png';
import BannerImage4 from '../../assets/images/banner/banner-eleven-info3.png';
import BannerImage5 from '../../assets/images/banner/banner-eleven-info1.png';
import BannerImage6 from '../../assets/images/banner/banner-eleven-circle.png';

function BannerSection() {
    return (
        <section id="home" className="banner-eleven-area paralax__animation">
            ...
            <div className="banner-eleven__wrp">
                <div className="banner-eleven__content">
                    ...
                    <div className="btns mt-40 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <Link to="/page-about" className="btn-one" data-splitting>Get
                            Started<i className="fa-regular fs-14 fa-angle-right"></i></Link>
            ...
            <div className="banner-eleven__image">
                <img data-depth="0.03" src={BannerImage2} alt="image"/>
                <div className="info1">
                    <img className="animation__arryUpDown" src={BannerImage3} alt="image"/>
                </div>
                <div className="info2">
                    <img className="animation__arryRightLeft" src={BannerImage4}
                        alt="image"/>
                </div>
                <div className="info3">
                    <img className="animation__arryDownUp" src={BannerImage5} alt="image"/>
                </div>
                <div className="circle">
                    <img className="animation__rotateAndScale" src={BannerImage6}
                        alt="image"/>
                </div>
            </div>
        </section>
