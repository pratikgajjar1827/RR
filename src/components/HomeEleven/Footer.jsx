...
function Footer({ className }) {
    ...
    return (
            <footer className={`footer-eleven-area ${className || ''}`}>
                <div className="footer-eleven-top">
                    <div className="container">
                        <div className="wrp">
                            <ul className="footer-menu">
                                <li><Link to="#0">Resources</Link></li>
                                <li><Link to="#0">Documentation</Link></li>
                                <li><Link to="#0">Developers</Link></li>
                                <li><Link to="#0">Portfolio</Link></li>
                            </ul>
                            <ul className="footer-info">
                                <li><Link to="#0"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                            ...
                            <div className="col-lg-7">
                                <div className="footer-eleven-righ mb-60">
                                    ...
                                    <div className="row g-4">
                                        <div className="col-md-4">
                                            <div className="footer-eleven__item">
                                                ...
                                                <ul>
                                                    <li><Link to="#0">stratify@example.com</Link></li>
                                                    <li><Link to="#0">+1 234 5644 5698</Link></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div className="col-md-4">
                                            <div className="footer-eleven__item">
                                                ...
                                                <ul>
                                                    <li><Link to="#0">Old Wesbury 356, New York <br /> 11230, United Stats</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div className="footer-eleven-bottom">
                                        <Link to="#0">Terms and Condition</Link>
                                        <Link to="#0">Privacy Policy</Link>
                                        <p>© 2025 <Link to="#0">Theme Mascot</Link>, All Rights Reserved</p>
                                    </div>
                                </div>
                            </div>
                        </div>
