...
import TestimonialImage1 from '../../assets/images/testimonial/testimonial-thirteen-image.jpg';
...
function TestimonialSection({ className }) {
    return (
            <section className={`testimonial-thirteen-area pt-130 pb-130 ${className || ''}`}>
