...
import ContactImage1 from '../../assets/images/bg/contact-six-bg.jpg';
import ContactImage2 from '../../assets/images/contact/contact-six-image.jpg';

function ContactSection({ className }) {
    const countOffer = 99;
    const countOffer2 = 86;
    const countOffer3 = 80;
    return (

            <section id="contacts" className={`contact-six-aera ${className || ''}`}>
                <div className="row g-0">
                    <div className="col-lg-7 order-2 order-lg-1">
                        <div className="contact-six__wrp" style={{ backgroundImage: `url(${ContactImage1})` }}>
                            <div className="contact-six__item">
                                ...
                                <div className="wrp">
                                    <div className="count-item wow fadeInDown" data-wow-delay="200ms"
                                        ...
                                        <h2 className="text-white"><span className="count text-white"><CounterUp count={countOffer} time={3} /></span>%</h2>
                                        <p className="text-white">Client Satisfaction</p>
                                    </div>
                                    <div className="count-item wow fadeInDown" data-wow-delay="300ms"
                                        data-wow-duration="1500ms">
                                        <h2 className="text-white"><span className="count text-white"><CounterUp count={countOffer2} time={3} /></span>+</h2>
                                        <p className="text-white">Expert Team</p>
                                    </div>
                                    <div className="count-item wow fadeInDown" data-wow-delay="400ms"
                                        data-wow-duration="1500ms">
                                        <h2 className="text-white"><span className="count text-white"><CounterUp count={countOffer3} time={3} /></span>%</h2>
                    ...
                    <div className="col-lg-5 order-1 order-lg-2">
                        <div className="contact-six__image ">
                            ...
                            <Link to="/contact" className="circle-btn">
