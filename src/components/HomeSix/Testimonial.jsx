...
import TestiThumb1 from '../../assets/images/testimonial/sing.png';
import TestiThumb2 from '../../assets/images/testimonial/testimonial-six-image.png';
...
function TestimonialSection({ className }) {
    return (
        <section className={`testimonial-six-area bg-sub pt-130 pb-130 ${className || ''}`}>
            <div className="testimonial-six__image animation__arryLeftRight">
                <img className="wow bounceInRight" src={TestiThumb2} alt="image"/>
                <div className="sign">
                    <img className="animation__arryUpDown" src={TestiThumb1} alt="sign-image"/>
                </div>
            </div>
