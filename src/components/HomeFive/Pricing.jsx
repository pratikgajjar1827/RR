...
import PricingImage from '../../assets/images/shape/pricing-five-item-shape.png'; 
                            ...
                            <div className="row g-4">
                                <div className="col-md-6 col-xxl-4">
                                    <div className="pricing-five__item">
                                        ...
                                        <Link to="/contact" className="pricing-btn">Get Started <i className="fa-light fa-arrow-right" /></Link>
                                        <ul>
                                ...
                                <div className="col-md-6 col-xxl-4">
                                    <div className="pricing-five__item popular">
                                        <div className="shape"><img src={PricingImage} alt="shape" /></div>
                                        <div className="head">
