...
import TestiUserlImage1 from '../../assets/images/testimonial/testimonial-five-user1.png';
import TestiUserlImage2 from '../../assets/images/testimonial/testimonial-five-user2.png';
import TestiUserlImage3 from '../../assets/images/testimonial/testimonial-five-user3.png';
import TestimonialImage1 from '../../assets/images/testimonial/testimonial-five-image.jpg';
import TestiLogo from '../../assets/images/icon/testi-logo.png';
import TestiStarLogo from '../../assets/images/icon/five-star.png';
...
function TestimonialSection({ className }) {
    return (
            <section className={`testimonial-five-area pt-130 pb-130 ${className || ''}`}>
                        ...
                        <div className="row g-5 align-items-center">
                            <div className="col-lg-6">
                                <div className="testimonial-five__image">
                                    ...
                                    <div className="image-content">
                                        <h4 className="title">5m+ Trusted <br />
                                            Global Clients</h4>
                                        <div className="users">
                                            <a href="#0"><img src={TestiUserlImage1}
                                                    alt="image"/></a>
                                            <a href="#0"><img src={TestiUserlImage2}
                                                    alt="image"/></a>
                                            <a href="#0"><img src={TestiUserlImage3}
                                                    alt="image"/></a>
                                            <a className="icon" href="#0"><i className="fa-sharp fa-solid fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="testimonial-five-right">
                                    ...
                                    <Swiper {...swiperOptions} className="swiper testimonial-five__slider">
                                            ...
                                            <SwiperSlide className="swiper-slide">
                                                <div className="testimonial-five__item">
                                                    ...
                                                    <div className="ratting">
                                                        <img src={TestiLogo} alt="icon"/>
                                                        <img src={TestiStarLogo} alt="icon"/>
                                                    </div>
                                                </div>
                                            </SwiperSlide>
                                            <SwiperSlide className="swiper-slide">
