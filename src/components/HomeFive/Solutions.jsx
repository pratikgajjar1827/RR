...
import SolutionsBgImage from '../../assets/images/bg/solution-bg-image.jpg'; 
import SolutionsImage1 from '../../assets/images/solution/solution-image1.jpg'; 
import SolutionsImage2 from '../../assets/images/solution/solution-image2.jpg'; 
import SolutionsImage3 from '../../assets/images/solution/solution-image3.jpg'; 

function Solutions() {
    return (
        <>
            
        <section id="project" className="solution-area have-padding pb-130" style={{ backgroundImage: `url(${SolutionsBgImage})` }}>
                    ...
                    <div className="row g-4">
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="solution__item">
                                <div className="image">
                                    <img src={SolutionsImage1} alt="image" />
                                </div>
                        ...
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="solution__item">
                                <div className="image">
                                    <img src={SolutionsImage2} alt="image" />
                                </div>
                                <div className="content">
                        ...
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="solution__item">
                                <div className="image">
                                    <img src={SolutionsImage3} alt="image" />
                                </div>
                                <div className="content">
