...
function Header({ className = '', scroll = false }) {
    ...
    return (
        ...
        <header id="home" className={`header-area header-blur ${className || ''}`}>
            <div className="container">
                <div className="header__main">
                    ...
                    <div className="main-menu main-menu-light">
                        ...
                        <div className="menu-btns light">
                            ...
                            <button onClick={toggleMobileMenu} className="menubars menubars-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#menubar">
                                <span></span>
                                <span></span>
                                <span></span>
                            </button>
