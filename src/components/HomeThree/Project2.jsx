...
import ProjectShapeImage from '../../assets/images/shape/project-three-item-shape.png'; 
import ProjectImage1 from '../../assets/images/project/project-three-image1.jpg'; 
import ProjectImage2 from '../../assets/images/project/project-three-image2.jpg'; 
import ProjectImage3 from '../../assets/images/project/project-three-image3.jpg'; 

function ProjectSection({ className }) {
    return (


<section className={`project-three-area pt-130 ${className || ''}`}>
    <div className="project-three__wrp">
        <div className="section-header text-center mb-50">
            <h6>LATEST PROJECT</h6>
            <h2 className="wow splt-txt" data-splitting>Unique Ideas For Your <br />
                Business Project</h2>
        </div>
            ...
            <div className="col-lg-6 col-xl-4">
                <div className="project-three__item">
                    <div className="project-three__content">
                        <div className="shape">
                            <img src={ProjectShapeImage} alt="shape"/>
                        </div>
                        <div className="icon">
                        ...
                        <div className="content">
                            <h4>.01</h4>
                            <h4><a className="hover-link-light" href="page-project-details.html">Marketing
                                    strategy</a></h4>
                            <p className="mt-15 mb-25">Reedfish bonefish trahira bristlenose catfish, longnose
                                lancetfish morid.</p>
                            <a href="page-project-details.html" className="arry-btn"><i
            ...
            <div className="col-lg-6 col-xl-4">
                <div className="project-three__item">
                    <div className="project-three__content">
                        ...
                        <div className="content">
                            <h4>.02</h4>
                            <h4><a className="hover-link-light" href="page-project-details.html">Brand Identity</a>
                            </h4>
                            <p className="mt-15 mb-25">Reedfish bonefish trahira bristlenose catfish, longnose
                                lancetfish morid.</p>
                            <a href="page-project-details.html" className="arry-btn"><i
                    ...
                    <div className="image">
                        <img src={ProjectImage2} alt="image"/>
                    </div>
                </div>
            </div>
            <div className="col-lg-6 col-xl-4">
                <div className="project-three__item">
                    <div className="project-three__content">
                        ...
                        <div className="content">
                            <h4>.03</h4>
                            <h4><a className="hover-link-light" href="page-project-details.html">Visual Design</a>
                            </h4>
                            <p className="mt-15 mb-25">Reedfish bonefish trahira bristlenose catfish, longnose
                                lancetfish morid.</p>
                            <a href="page-project-details.html" className="arry-btn"><i
                    ...
                    <div className="image">
                        <img src={ProjectImage3} alt="image"/>
                    </div>
                </div>
            </div>
        </div>
