...
import ChooseImage1 from '../../assets/images/choose/choose-three-image.jpg'; 
import ChooseImage2 from '../../assets/images/choose/choose-three-chart.png'; 
import ChooseImage3 from '../../assets/images/solution/solution-image1.jpg';  
import ChooseImage4 from '../../assets/images/solution/solution-image2.jpg';  
import ChooseImage5 from '../../assets/images/solution/solution-image3.jpg';  
import ChooseImage6 from '../../assets/images/choose/choose-one-image.jpg';  
import ChooseImage7 from '../../assets/images/shape/work-eleven-line.png';  
import ChooseImage8 from '../../assets/images/work/work-ten-image1.png';  
import ChooseImage9 from '../../assets/images/work/work-ten-image2.png';  
import ChooseImage10 from '../../assets/images/work/work-ten-image3.png';  
import ChooseImage11 from '../../assets/images/work/work-ten-image4.png';  
import ChooseBgImage1 from '../../assets/images/bg/solution-bg-image.jpg'; 
            ...
            <div className="choose-three__tab-content">
                <div className="tab-content" id="myTabContent">
                    <div className={activeIndex === 1 ? "tab-pane fade show active" : "tab-pane fade show"} id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div className="row g-0">
                            <div className="col-xl-5">
                                <div className="choose-three__image wow">
                                ...
                                <div className="choose-three__wrp">
                                    ...
                                    <div className="choose-three-right">
                                        <div className="choose-three__content">
                                            ...
                                            <Link to="/page-about" className="btn-one mt-20 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms" data-splitting data-text="Discover More">Discover More</Link>
                                        </div>
                                        <div className="choose-three__chart wow">
                                            <img src={ChooseImage2} alt="chart-image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className={activeIndex === 2 ? "tab-pane fade show active" : "tab-pane fade show"} id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div className="solution-area pt-130 pb-130" style={{ backgroundImage: `url(${ChooseBgImage1})` }} >
                            <div className="container">
                                            ...
                                            <div className="solution__item">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="title">
                                                        ...
                                                        <h4 className="text-white"><Link to="/">Defense Arsenal Unveiling Our Cyber Security Suite</Link></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="solution__item">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="title">
                                                        ...
                                                        <h4 className="text-white"><Link to="/">Fortified Protection Explore Our Robust Security Features</Link></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="solution__item">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="title">
                                                        ...
                                                        <h4 className="text-white"><Link to="/">Empowering Digital Safety at Every Level Protection</Link></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className={activeIndex === 4 ? "tab-pane fade show active" : "tab-pane fade show"} id="settings" role="tabpanel" aria-labelledby="settings-tab">
                        <div className="work-eleven__wrp">
                            <div className="work-eleven__line">
                                <img src={ChooseImage7} alt="shape" />
                            </div>
                            <div className="work-eleven__item have-margin">
                                <div className="image">
                                    <img src={ChooseImage8} alt="image" />
                                    <span className="number">1</span>
                                </div>
                                <div className="content">
                            ...
                            <div className="work-eleven__item">
                                <div className="image">
                                    <img src={ChooseImage9} alt="image" />
                                    <span className="number">2</span>
                                </div>
                                <div className="content">
                            ...
                            <div className="work-eleven__item have-margin">
                                <div className="image">
                                    <img src={ChooseImage10} alt="image" />
                                    <span className="number">3</span>
                                </div>
                                <div className="content">
                            ...
                            <div className="work-eleven__item">
                                <div className="image">
                                    <img src={ChooseImage11} alt="image" />
