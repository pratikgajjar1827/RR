...
import FaqImage1 from '../../assets/images/faq/faq-image.jpg';
import FaqImage2 from '../../assets/images/faq/faq-icon.png';
    ...
    return (
        ...
        <section className="faq-area bg-sub">
            <div className="row g-0 align-items-center">
                <div className="col-xl-6">
                    <div className="faq__item">
                        ...
                        <div className="faq__accordion wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <h5>
                                <Link to="/page-faq" className="faq-btn hover-link mt-30">See More And Ask Us Questions
                ...
                <div className="col-xl-6">
                    <div className="faq__image gsap__parallax wow">
                        <img src={FaqImage1} alt="image" />
                        <div className="icon">
                            <img src={FaqImage2} alt="image" />
                        </div>
                    </div>
                </div>
            </div>
