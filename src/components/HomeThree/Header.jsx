            ...
            <div className="container">
                <div className="header-top__wrp">
                    ...
                    <div className="header-top__socials">
                        ...
                        <Link to="#"><svg width="13" height="15" viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Link className="pe-0" to="#"><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="header__main">
                    ...
                    <div className="main-menu">
                        ...
                        <div className="menu-btns">
                            ...
                            <button onClick={toggleMobileMenu} className="menubars" type="button" data-bs-toggle="offcanvas"
