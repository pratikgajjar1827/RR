...
import SlideImage1 from '../../assets/images/video/banner-eight-video.mp4';  
;
...
function BannerSection() {
    ...
    return (
        ...
        <section className="banner-eight-area paralax__animation">
            ...
            <div className="container">
                <div className="banner-eight__content">
                    ...
                    <div className="btns mt-40">
                        <Link data-depth="0.05" to="/page-about" className="btn-two-light wow fadeInUp"
                            data-wow-delay="400ms" data-wow-duration="1500ms">About
                            Us<i className="fa-light fa-arrow-right"></i></Link>
                        <Link data-depth="0.05" to="/page-services" className="btn-one-light wow fadeInUp"
