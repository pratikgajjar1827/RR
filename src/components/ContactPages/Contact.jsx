...
import ContactImage1 from '../../assets/images/contact/map.png';
import ContactImage2 from '../../assets/images/contact/map-location.png';
                                ...
                                <div className="contact-two__content">
                                    ...
                                    <ul>
                                        <li className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                            ...
                                            <Link to="#0">4140 Parker Rd. Allentown, New Mexico 31134</Link>
                                        </li>
                                        <li className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                            ...
                                            <a href="mailto:needhelp@example.com">needhelp@example.com, 0123 4463 745</a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="contact-two__form">
                                    <form id="contact_form" name="contact_form" action="#" method="post">
                                        <div className="row g-4 mb-4">
                                            <div className="col-6">
                                                <div className="input">
                                                    <input name="form_name" type="text" placeholder="Enter Name"/>
                                                </div>
                                            </div>
                                            <div className="col-6">
                                                <div className="input">
                                                    <input name="form_email" className="required email" type="email" placeholder="E-mail address"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" className="btn-one mt-50" data-loading-text="Please wait...">Send message</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-6 order-1 order-xl-2">
                            <div className="contact-two__map">
                                ...
                                <div className="location">
                                    <img className="wow bounceIn" src={ContactImage2} alt="image"/>
                                </div>
                            </div>
                        </div>
                    </div>
