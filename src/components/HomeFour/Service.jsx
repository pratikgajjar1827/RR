...
import ServicesImage1 from '../../assets/images/service/service-image1.jpg'; 
import ServicesImage2 from '../../assets/images/service/service-image2.jpg'; 
import ServicesImage3 from '../../assets/images/service/service-image3.jpg'; 
import ServicesImage4 from '../../assets/images/service/service-image4.jpg'; 

function ServicesSection({ className }) {
    return (
        <section id="services" className={`service-four-aera pt-130 pb-130 ${className || ''}`}>
                    ...
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div className="service-four__item">
                            <div className="content">
                                ...
                                <h4 className="title"><Link to="/page-service-details">Business Strategy and Planning</Link>
                                </h4>
                            </div>
                            <div className="image">
                    ...
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="service-four__item">
                            <div className="content">
                                ...
                                <h4 className="title"><Link to="/page-service-details">International Business
                                        Consulting</Link></h4>
                            </div>
                            <div className="image">
                                <img src={ServicesImage2} alt="image"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="service-four__item">
                            <div className="content">
                                ...
                                <h4 className="title"><Link to="/page-service-details">E-Commerce and Market</Link></h4>
                            </div>
                            <div className="image">
                                <img src={ServicesImage3} alt="image"/>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div className="service-four__item">
                            <div className="content">
                                ...
                                <h4 className="title"><Link to="/page-service-details">Human Resources and Management</Link>
                                </h4>
                            </div>
                            <div className="image">
                                <img src={ServicesImage4} alt="image"/>
                            </div>
                        </div>
                    </div>
                </div>
