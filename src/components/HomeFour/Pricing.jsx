...
import ServiceImage1 from '../../assets/images/service/service-image1.jpg';
import ServiceImage2 from '../../assets/images/service/service-image2.jpg';
import ServiceImage3 from '../../assets/images/service/service-image3.jpg';
import ServiceImage4 from '../../assets/images/service/service-image4.jpg';

function PricingSection({ className }) {
    return (
        <section className={`pricing-area pb-130 ${className || ''}`}>
                    ...
                    <div className="row g-4">
                        <div className="col-lg-6 col-xxl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="pricing__item">
                                ...
                                <Link to="/page-pricing" className="btn-one mb-20 w-100 rounded-0" data-splitting
                                    data-text="Get Started With Plan">Get
                                    Started With Plan</Link>
                                <Link to="/page-pricing" className="btn-two w-100 rounded-0" data-splitting
                                ...
                                <ul>
                                    ...
                                    <li><i className="fa-light fa-check"></i> Basic Security Systems</li>
                                    <li><i className="fa-light fa-xmark"></i> Smart Lighting Control</li>
                                    <li><i className="fa-light fa-xmark"></i> Power And Predictive Dialling</li>
                                    <li><i className="fa-light fa-xmark"></i> Free Consultation Until Cooperation</li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-6 col-xxl-4 wow fadeInLeft" data-wow-delay="200ms"
                            ...
                            <div className="pricing__item popular">
                                ...
                                <Link to="/page-pricing" className="btn-one-light mb-20 w-100 rounded-0" data-splitting
                                    data-text="Get Started With Plan">Get
                                    Started With Plan</Link>
                                <Link to="/page-pricing" className="btn-two-light w-100 rounded-0" data-splitting
                                    data-text="Chat to Sales">Chat to Sales</Link>
                                <ul>
                                    <li><i className="fa-light fa-check"></i> 24/7 Support at Any Time</li>
                                    <li><i className="fa-light fa-check"></i> Orientation for Business</li>
                                    <li><i className="fa-light fa-check"></i> Basic Security Systems</li>
                                    <li><i className="fa-light fa-check"></i> Smart Lighting Control</li>
                                    <li><i className="fa-light fa-check"></i> Power And Predictive Dialling</li>
                                    <li><i className="fa-light fa-xmark"></i> Free Consultation Until Cooperation</li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-6 col-xxl-4 wow fadeInLeft" data-wow-delay="400ms"
                            ...
                            <div className="pricing__item">
                                ...
                                <ul>
                                    ...
                                    <li><i className="fa-light fa-check"></i> Smart Lighting Control</li>
                                    <li><i className="fa-light fa-check"></i> Power And Predictive Dialling</li>
                                    <li><i className="fa-light fa-check"></i> Free Consultation Until Cooperation</li>
                                </ul>
                            </div>
                        </div>
                    </div>
