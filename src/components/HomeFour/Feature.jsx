...
import Featuremage1 from '../../assets/images/feature/feature-four-user.png';

function Feature({ className }) {
    const [isOpen, setOpen] = useState(false);
    const countOffer = 200;
    
    return (
        <>
        <section id="about" className={`feature-four-area ${className || ''}`}>
                ...
                <div className="row g-5 g-lg-0 align-items-end">
                        ...
                        <div className="feature-four__item about__funfact">
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>
                                        <h3><span className="count"><CounterUp count={countOffer} time={3} /></span>k<sup>+</sup></h3>
                                    </li>
                                </ul>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="feature-four__item item-middle">
                            <img src={Featuremage1} alt="image"/>
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="footer__item-last feature-four__item">
                            ...
                            <div className="mailUs mt-10">
                                <span className="text-white"><i className="fa-light fa-envelope"></i></span>
                                <input type="email" placeholder="Enter your email"/>
                                <button><i className="fa-sharp fa-solid text-white fa-paper-plane"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
