            ...
            <div className="container">
                <div className="header-top__wrp">
                    ...
                    <ul className="header-top__links four-links">
                        ...
                        <li><i className="fa-light fa-envelope-open-text"></i> <a
                                href="mailto:info.company@gmail.com">info.company@gmail.com</a></li>
                        <li><i className="fa-light fa-clock"></i> <a href="#0">Mon - Frd : 8:00 -16:00</a></li>
                    </ul>
            ...
            <div className="container">
                <div className="header__main">
                    ...
                    <div className="menu-btns light">
                        ...
                        <button className="menubars menubars-light" onClick={toggleMobileMenu}>
                            <span></span>
                            <span></span>
                            <span></span>
                        </button>
                        <Link to="/contact" className="header-four__btn">
                            Get in Touch <i className="fa-light fa-arrow-up-right"></i>
                        </Link>
                    </div>
                </div>
            </div>
