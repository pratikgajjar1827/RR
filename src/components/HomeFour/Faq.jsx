...
import Accordion3 from '../../lib/Accordion3.jsx'; 
import FaqImage1 from '../../assets/images/faq/faq-four-image.jpg';
                ...
                <div className="col-xl-6">
                    <div className="faq__item">
                        ...
                        <div className="faq__accordion wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <h5>
                                <Link to="/page-faq" className="faq-btn hover-link mt-30">Check More Questions Now
