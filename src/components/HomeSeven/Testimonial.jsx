...
import TestiThumb1 from '../../assets/images/professional/professional-seven-image1.jpg';
import TestiThumb2 from '../../assets/images/professional/professional-seven-image2.jpg';
import TestiThumb3 from '../../assets/images/professional/professional-seven-image3.jpg';
import TestiShapeImage from '../../assets/images/shape/professtion-seven-shape.png';
...
function TestimonialSection({ className }) {
    ...
    return (
        <section className={`professional-seven-area pb-130 ${className || ''}`}>
            <div className="professional-seven__wrp">
                <div className="row g-5">
                    <div className="col-lg-7">
                        <div className="professional-seven__image">
                            <Swiper {...swiperOptions} className="swiper professional-seven__slider">
                    ...
                    <div className="col-lg-5">
                        <div className="professional-seven__content">
                            <div className="section-header">
                                ...
                                <p className="wow fadeInUp text" data-wow-delay="00ms" data-wow-duration="1500ms">There are
                                    many
            ...
            <div className="professional-seven__shape">
                <img src={TestiShapeImage} alt="shape"/>
            </div>
        </section>
    );
}
