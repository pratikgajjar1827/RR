...
import ChooseImage1 from '../../assets/images/choose/choose-seven-image1.jpg';
import ChooseImage2 from '../../assets/images/choose/choose-seven-image2.jpg';
import ChooseImage3 from '../../assets/images/choose/choose-seven-image3.jpg';
import StarImage from '../../assets/images/icon/five-star.png';
...
function ChooseUs({ className }) {
    return (
        <>
        <section id="project" className="choose-seven-area">
                ...
                <div className="col-lg-6">
                    <div className="choose-seven__wrp">
                        <div className="wrp">
                            ...
                            <Swiper {...swiperOptions} className="swiper testimonial-seven__slider">
                            ...
                            <div className="slider-arry">
                                <button className="testimonial-seven__arry-prev"><i
                                    className="fa-light fa-arrow-left-long"></i></button>
                                <button className="testimonial-seven__arry-next"><i
                ...
                <div className="col-lg-6 order-2 order-lg-1">
                    <div className="choose-seven__wrp">
                        <div className="wrp">
                            ...
                            <div className="row g-4">
                                <div className="col-sm-6 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <div className="item">
                                        ...
                                        <h4 className="my-3"><Link to="/page-service-details" className="hover-link">Business
                                                Strategies</Link></h4>
                            ...
                            <Link to="/contact" className="btn-one mt-50 wow fadeInUp" data-wow-delay="400ms"
