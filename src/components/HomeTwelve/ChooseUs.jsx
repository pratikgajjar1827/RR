...
import ChooseUsImage1 from '../../assets/images/choose/choose-twelve-image.jpg'; 

function ChooseUsSection({ className }) {
    ...
    return (
        ...
        <section className={`choose-twelve-area ${className || ''}`}>
            <div className="row g-0">
                <div className="col-lg-5">
                    <div className="choose-twelve__image">
                        <img src={ChooseUsImage1} alt="image"/>
                    </div>
                </div>
                <div className="col-lg-7">
                    <div className="choose-twelve__wrp">
                        ...
                        <div className="choose__tab">
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button className={activeIndex === 1 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(1)} id="home-tab" data-bs-toggle="tab"
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className={activeIndex === 2 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(2)} id="profile-tab" data-bs-toggle="tab"
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className={activeIndex === 3 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(3)} id="contact-tab" data-bs-toggle="tab"
                                ...
                                <li className="nav-item" role="presentation">
                                    <button className={activeIndex === 4 ? "nav-link active" : "nav-link"} onClick={() => handleOnClick(4)} id="history-tab" data-bs-toggle="tab"
                        ...
                        <div className="tab-content mt-30" id="myTabContent">
                            <div className={activeIndex === 1 ? "tab-pane fade animated  show active" : "tab-pane"} id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div className="choose-twelve__content">
                                    ...
                                    <Link to="/page-about" className="btn-one wow fadeInDown" data-wow-delay="400ms"
                                        data-wow-duration="1500ms" data-splitting data-text="About Us">About Us</Link>
                                </div>
                            </div>

                            <div className={activeIndex === 2 ? "tab-pane fade animated  show active" : "tab-pane"} id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div className="choose-twelve__content">
                                    <p>From
                                        advanced
                                        digital technologies to the forefront of sustainable solutions, we’re
                                    ...
                                    <Link to="/page-about" className="btn-one" data-splitting data-text="About Us">About
                                        Us</Link>
                                </div>
                            </div>

                            <div className={activeIndex === 3 ? "tab-pane fade animated  show active" : "tab-pane"} id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                <div className="choose-twelve__content">
                                    <p>From
                                        advanced
                                        digital technologies to the forefront of sustainable solutions, we’re
                            ...
                            <div className={activeIndex === 4 ? "tab-pane fade animated  show active" : "tab-pane"} id="history" role="tabpanel" aria-labelledby="history-tab">
                                <div className="choose-twelve__content">
                                    <p>From
                                        advanced
                                        digital technologies to the forefront of sustainable solutions, we’re
