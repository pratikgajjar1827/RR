...
function Header({ className = '', scroll = false }) {
    ...
    return (
        <>
        <header className={`header-area header-dark-area ${className || ''}`}>
                ...
                <div className="header__main">
                    ...
                    <div className="main-menu main-menu-light">
                        ...
                        <div className="menu-btns light header-twelve__btns">
                            <Link to="/contact" className="btn-two-light rounded-0" data-splitting>Free
                                Consultant <i className="fa-regular fa-arrow-right"></i></Link>
