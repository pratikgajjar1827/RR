...
import SlideImage1 from '../../assets/images/banner/banner-nine-image.jpg';  
import SlideImage2 from '../../assets/images/banner/banner-nine-circle.png';  
...
function BannerSection() {
    ...
    <section className="banner-nine-area">
        <div className="row g-0 align-items-center">
                ...
                <div className="banner-nine__content">
                    ...
                    <div>
                        <div className="wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <Link to="#feature" className="arry-btn animation__arryUpDown"><i
            ...
            <div className="col-xl-6 order-1 order-xl-2">
                <div className="banner-nine__image wow">
                    <img className="parallaxRightScroll" src={SlideImage1} alt="image"/>
                </div>
            </div>
        </div>
        <div className="banner-nine__circle">
            <img className="animation__rotate" src={SlideImage2} alt="image"/>
        </div>
    </section>
    );
}
