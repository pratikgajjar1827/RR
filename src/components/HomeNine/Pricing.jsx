...
import PricingImage from '../../assets/images/shape/pricing-nine-item-shape.png';  
function Pricing() {
    return (
        <>
                    ...
                    <div className="row g-4">
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="pricing-nine__item">
                                ...
                                <Link to="#0" className="btn-more">Purchase Now <i className="fa-light fa-arrow-right"></i></Link>
                            </div>
                        </div>
                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div className="pricing-nine__item popular">
                                <div className="shape">
                                    <img src={PricingImage} alt="shape"/>
                                </div>
                                <div className="head">
                                    <div>
